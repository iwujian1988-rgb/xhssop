...
function ShowcaseScreenshotCover({ payload, className, referenceImage }: CoverProps & { referenceImage?: string }) {
  ...
  return <article className={`showcase-screenshot-cover showcase-screenshot-cover--${variant} ${className}`} aria-label={payload.title}>
    ...
    <style>{`.showcase-screenshot-cover{position:relative;width:100%;aspect-ratio:3/4;overflow:hidden;background:#ddd;container-type:inline-size;box-shadow:0 20px 48px rgba(0,0,0,.18)}.showcase-screenshot-cover>img{position:absolute;inset:0;width:100%;height:100%;object-fit:cover}.showcase-screenshot-cover__veil{position:absolute;inset:0;background:linear-gradient(180deg,transparent 38%,rgba(0,0,0,.12) 100%)}.showcase-screenshot-cover__copy{position:absolute;right:3%;bottom:12%;left:3%;text-align:center}.showcase-screenshot-cover h1{position:relative;margin:0 auto;max-width:96%;font-size:clamp(30px,10.2cqw,82px);font-weight:950;line-height:.98;letter-spacing:0;text-wrap:balance;overflow-wrap:anywhere;color:#ffd51b;text-shadow:3px 3px 0 #111,-3px -3px 0 #111,3px -3px 0 #111,-3px 3px 0 #111,0 5px 10px rgba(0,0,0,.42)}.showcase-screenshot-cover p{position:relative;margin:2.5cqw auto 0;max-width:86%;font-size:clamp(13px,3.5cqw,28px);font-weight:900;line-height:1.1;color:#fff;text-shadow:2px 2px 0 #111,-2px -2px 0 #111,2px -2px 0 #111,-2px 2px 0 #111}.showcase-screenshot-cover--white h1{color:#fff}.showcase-screenshot-cover--white .showcase-screenshot-cover__veil{background:linear-gradient(180deg,transparent 30%,rgba(0,0,0,.3) 100%)}.showcase-screenshot-cover--paper .showcase-screenshot-cover__copy{bottom:8%;left:5%;right:5%;padding:2.4cqw 1.5cqw;background:rgba(255,255,255,.88);transform:rotate(-1deg)}.showcase-screenshot-cover--paper h1{color:#111;text-shadow:2px 2px 0 #fff,-2px -2px 0 #fff}.showcase-screenshot-cover--ink .showcase-screenshot-cover__copy{bottom:8%;padding:2cqw 1cqw;background:rgba(255,255,255,.9)}.showcase-screenshot-cover--ink h1{color:#111;text-shadow:2px 2px 0 #fff,-2px -2px 0 #fff}.showcase-screenshot-cover--underline h1{text-decoration:underline;text-decoration-color:#f5d63d;text-decoration-thickness:1cqw;text-underline-offset:1.2cqw}`}</style>
  </article>;
}
