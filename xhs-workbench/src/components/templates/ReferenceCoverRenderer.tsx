...
function BlackboardPhrase({ payload, className }: CoverProps) {
  ...
  const bodySize = itemCount > 18 || averageLength > 22 ? '2.42cqw' : itemCount > 15 ? '2.7cqw' : '3cqw';
  const titleSize = payload.title.length > 16 ? '6.4cqw' : '7.2cqw';
...
function BlackboardOffer({ payload, className }: CoverProps) {
  const titleSize = payload.title.length > 18 ? '6.15cqw' : payload.title.length > 13 ? '6.8cqw' : '7.5cqw';
...
function BaseStyles() { return <style>{`
  ...
  .rc-blackboard{color:#fff;font-family:"Noto Sans SC","Microsoft YaHei",sans-serif}.rc-blackboard:after{content:"";position:absolute;inset:0;background:rgba(0,35,20,.12)}.rc-blackboard header,.rc-chalk-groups,.rc-offer-groups{position:relative;z-index:1}.rc-blackboard header{padding:5cqw 5.5cqw 1.8cqw;text-align:center}.rc-blackboard header h1{font-family:"STXinwei","FZShuTi",serif;font-size:var(--chalk-title);font-weight:500;line-height:1.06}.rc-blackboard header p{margin-top:1.2cqw;color:#ffd84a;font-size:2.9cqw;font-weight:800}.rc-chalk-groups{display:grid;grid-template-columns:repeat(2,1fr);gap:4.5cqw;height:76%;padding:2cqw 5.5cqw 3cqw}.rc-chalk-groups section{display:flex;min-height:0;flex-direction:column}.rc-chalk-groups h2{display:inline-block;align-self:flex-start;margin-bottom:1.1cqw;border-bottom:.45cqw solid #f7c52e;font-family:"Source Han Serif SC Heavy","Noto Serif SC",serif;font-size:3.45cqw}.rc-chalk-groups section>div{display:flex;min-height:0;flex:1;flex-direction:column;justify-content:space-evenly}.rc-chalk-groups p{overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;padding:.5cqw 0;border-bottom:.12cqw dashed rgba(255,255,255,.3);font-size:var(--chalk-body);line-height:1.16;white-space:normal}.rc-chalk-groups b{font-family:Georgia,"Noto Serif SC",serif}.rc-chalk-groups span{margin-left:.5cqw;color:#f4e8bc;font-size:.86em}.rc-offer header{padding-bottom:1cqw}.rc-offer header h1{font-size:var(--offer-title)}.rc-offer-groups{display:flex;flex-direction:column;justify-content:space-between;height:71%;padding:1cqw 7cqw 3cqw;overflow:hidden}.rc-offer-groups section{display:flex;flex-shrink:0;flex-direction:column;justify-content:flex-start;padding-bottom:.5cqw;border-bottom:.16cqw dashed rgba(255,255,255,.34)}.rc-offer-groups h2{align-self:flex-start;padding:.45cqw 1.15cqw;background:#f1c735;color:#173c2c;font-family:"Source Han Serif SC Heavy","Noto Serif SC",serif;font-size:clamp(12px, calc(3.4cqw * var(--fit-scale, 1)), 27px)}.rc-offer-groups p{overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;margin-top:calc(1cqw * var(--fit-scale, 1));font-size:clamp(10.5px, calc(3.18cqw * var(--fit-scale, 1)), 25px);font-weight:600;line-height:1.28;white-space:normal}.rc-offer-groups p b{color:#fff;font-weight:900}
  ...
  .rc-experience{position:relative;display:flex;overflow:hidden;height:100%;flex-direction:column;padding:6.2cqw 6.4cqw;background:#fff;font-family:"PingFang SC","Microsoft YaHei",sans-serif}.rc-rule{flex:0 0 auto;height:.18cqw;margin-top:8cqw;background:#aaa}.rc-experience h1{overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;flex:0 0 auto;margin-top:5.4cqw;font-size:var(--exp-title,8.2cqw);font-weight:950;line-height:1.22;overflow-wrap:anywhere;word-break:normal;text-decoration:underline;text-decoration-thickness:.35cqw;text-underline-offset:1.1cqw}.rc-experience-lead{overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;flex:0 0 auto;margin-top:8.5cqw;font-size:4.25cqw;font-weight:500;line-height:1.6;overflow-wrap:anywhere;word-break:normal}.rc-experience-body{display:flex;overflow:hidden;flex:1 1 auto;flex-direction:column;justify-content:space-between;min-height:0}.rc-experience-paragraph{overflow:hidden;display:-webkit-box;-webkit-line-clamp:6;-webkit-box-orient:vertical;flex-shrink:0;margin-top:calc(5cqw * var(--fit-scale, 1))!important;font-size:clamp(12px, calc(4.5cqw * var(--fit-scale, 1)), 36px);line-height:1.68;overflow-wrap:anywhere!important;word-break:normal!important}
  ...
  .rc-memo>h1{font-size:clamp(28px,6.7cqw,58px);line-height:1.05}.rc-memo-sections{margin-top:4.2cqw}.rc-memo-sections p{line-height:1.34}
