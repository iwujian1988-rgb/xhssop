...
const profiles: Record<ProductId, ProductPromptProfile> = {
  ...
  tcf_canada_writing_7day: {
    ...
    adminName: '商品3：TCF Canada写作考前7天急救锦囊',
    noteIdentity: 'TCF Canada写作',
    shortIdentity: 'TCF Canada写作',
    requiredIdentityPattern: /TCF\s*Canada|TCF\s*加拿大|TCF\s*写作|加拿大法语写作/i,
    forbiddenIdentityPattern: /\bDELF\b|\bDALF\b|\bTEF\b|\bCLB\s*\d*\b|\bNCLC\s*\d*\b/i,
    topicScopePrompt: '当前是商品3：TCF Canada写作考前7天急救锦囊。选题只围绕TCF Canada写作的T1、T2、T3、任务格式、字数核对、信息完整、评论展开、材料比较、观点展开、语体和考后纠错。禁止写成DELF B2、TEF Canada、口语或听力资料。可以做学习方法和原创练习，但不得冒充官方真题或题目预测。',
    contentScopePrompt: '当前是商品3。所有用户可见内容只能围绕TCF Canada写作T1/T2/T3和考前7天纠错训练。明确区分T1信息、T2评论、T3材料比较与观点展开。不要把训练建议写成官方评分硬规则，不要混入DELF或TEF内容。',
    ...
    coverFallbackTitles: {
      directory: 'TCF Canada写作7天急救资料',
      phrase: 'TCF Canada写作展开表达',
      offer: 'TCF Canada写作急救锦囊',
      flashcard: 'TCF Canada写作纠错卡',
      book: 'TCF Canada写作训练手册',
      pain: 'TCF Canada写作别再只重写',
      experience: 'TCF Canada写作7天复盘',
      document: 'TCF Canada写作素材解析',
      table: 'TCF Canada写作任务速查',
      roadmap: 'TCF Canada写作7天路径',
    },
  },
};
